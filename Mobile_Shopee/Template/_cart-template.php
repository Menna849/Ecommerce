...
<section id="cart" class="py-3">
    <div class="container-fluid w-75">
        ...
        <div class="raw">
            <div class="col-sm-9">
                <!--cart item-->
                <div class="raw border-top py-3 mt-3">
                    <div class="col-sm-2">
            ...
            <!--subtotal section-->
            <div class="col-sm-3">
                <div class="sub-total border text-danger mt-2">
                    <h6 class="font-size-12 font-rale text-success py-3"><i class="fas fa-check"></i> order is eligible for FREE Delivery.</h6>
